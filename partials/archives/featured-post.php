...
// Get featured post
$featured_post_id = $args['post_id'] ?? 0;
...
if ( $featured_post_id ) : ?>
	...
	<div class="pwd-featured-post">
		<a href="<?php echo esc_url( get_permalink( $featured_post_id ) ); ?>" title="<?php echo esc_attr( get_the_title( $featured_post_id ) ); ?>">
			...
			<div class="pwd-featured-post-content">
				...
				if ( 'post' == get_post_type( $featured_post_id ) ) :
					...
					$cat  = $cats[0]; ?>
					<div class="pwd-featured-post-cat term-<?php echo esc_attr( $cat->term_id ); ?>"><?php echo esc_html( $cat->name );  ?></div>
				<?php endif; ?>
