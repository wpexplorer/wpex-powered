 ...
 * @since Total 1.6.0
 */
class Powered_Fonts_Dropdown_Control extends WP_Customize_Control {
 ...
 * @since 1.0.0
 */
function pwd_standard_fonts_array() {
	return apply_filters( 'pwd_standard_fonts_array', array(
